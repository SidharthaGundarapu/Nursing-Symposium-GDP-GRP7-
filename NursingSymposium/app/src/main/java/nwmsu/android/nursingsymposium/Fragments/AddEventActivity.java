...
public class AddEventActivity extends AppCompatActivity {
    ...
    String imagestring="";
    TextInputEditText id_conferenceName,id_description,id_time,id_speaker,id_locationss,id_aboutspeaker;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_event);
        selectDate=findViewById(R.id.selectDate);
        id_aboutspeaker=findViewById(R.id.id_aboutspeaker);
        ...
        submitevent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String aboutSpeaker=id_aboutspeaker.getText().toString();
                ...
                if(TextUtils.isEmpty(name)){
                ...
                } else if(TextUtils.isEmpty(aboutSpeaker)){
                    Toast.makeText(AddEventActivity.this, "Enter AboutSpeaker", Toast.LENGTH_SHORT).show();
                    ...
                    String keysss= FirebaseAuth.getInstance().getUid();

                    FirebaseDatabase firebaseDatabase=FirebaseDatabase.getInstance();
                    DatabaseReference databaseReference=firebaseDatabase.getReference("Events");
                    String keyyy=databaseReference.push().getKey();


                    ConferenceDataModel conferenceDataModel=new ConferenceDataModel(
                            pic,name,location,date,name,time,speaker,"",key,description,aboutSpeaker
                    );

                    databaseReference.child(keyyy).setValue(conferenceDataModel);
                    finish();
